...
files = main.cpp PhysicsHandler.cpp SoftBody.cpp Node.cpp Drawer.cpp
...
profiling: libprofiling FORCE
	sleep 1s
	g++ -o app $(files) $(wildcard Oxide/Oxide/build/*.o) -DTRACY_ENABLE -I vendor/ -I Oxide/Oxide/src/ -I Oxide/Oxide/vendor/ -LOxide/Oxide/vendor/lib -L/usr/local/lib $(links) -std=c++2a -O2 -march=native
